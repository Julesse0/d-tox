        ...
        <div className="grid items-start gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
          ...
          <div className="flex flex-col gap-8 lg:pt-6">
            <div className="space-y-4">
              <p className="font-sans text-xs uppercase tracking-[0.32em] text-[#704919] font-medium">
                {eyebrow}
              </p>
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#704919] px-7 py-4 font-sans text-sm font-medium uppercase tracking-[0.18em] text-white transition-colors hover:bg-[#826730]"
              >
                {primaryCta.label}
              ...
              {secondaryCta && (
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 border border-[#1A1A1A]/12 px-7 py-4 font-sans text-sm font-medium uppercase tracking-[0.18em] text-[#1A1A1A] transition-colors hover:border-[#704919] hover:text-[#704919]"
                >
                  {secondaryCta.label}
                </Link>
              )}
