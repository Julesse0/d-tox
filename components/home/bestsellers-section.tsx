    ...
    <section className="bg-[#F6F1E8] py-24 lg:py-28">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          ...
          <Link
            href="/produits"
            className="inline-flex items-center gap-2 font-sans text-sm uppercase tracking-widest text-[#f6bf5a] hover:text-[#d99a35] transition-colors"
          >
            Voir tout
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {products.map((product) => (
            <Link key={product.name} href={product.href} className="group">
              <div className="flex flex-col gap-6 rounded-lg border border-[#f6bf5a]/10 bg-[rgba(255,250,243,0.82)] p-6 shadow-[0_18px_44px_rgba(36,28,20,0.06)] md:p-8">
                ...
                <div className="flex flex-col gap-3">
                  <h3 className="font-serif text-xl font-bold text-[#1A1A1A] uppercase tracking-wide group-hover:text-[#f6bf5a] transition-colors">
                    {product.name}
                  </h3>
