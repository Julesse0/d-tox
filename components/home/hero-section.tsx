  ...
  return (
    <section className="relative min-h-screen bg-[#1A1A1A] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 w-full pt-32 pb-20">
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-8 text-center">
          <div className="flex flex-col gap-4">
            ...
            <h1 className="font-serif text-6xl md:text-7xl lg:text-8xl font-bold text-[#F6F1E8] leading-none tracking-tight text-balance">
              D-tox
            </h1>
            <p className="mx-auto max-w-2xl font-sans font-light text-lg md:text-xl text-[#F6F1E8]/72 leading-relaxed">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
        <span className="font-sans text-[10px] uppercase tracking-widest text-[#F6F1E8]/40">Defiler</span>
        <div className="w-px h-8 bg-[#F6F1E8]/20" />
      </div>
    </section>
  )
}
