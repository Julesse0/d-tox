...
export const blogSectionMeta = {
  ...
  articles: {
    label: "News",
    title: "News",
    description: "Les nouveautÃ©s DTÖX, les sujets autour du kombucha et les contenus de fond les plus utiles.",
    href: "/blog/articles",
  },
  recettes: {
    label: "Recettes",
    title: "Recettes",
    description: "Cocktails, accords et inspirations Ã  servir avec DTÖX pour un usage plus lifestyle et convivial.",
    href: "/blog/recettes",
  },
  supports: {
    label: "Guides",
    title: "Guides pratiques",
    description: "Conservation, emballage et infos pratiques issues des archives DTÖX.",
    href: "/blog/supports",
  },
  reseaux: {
...
const titleOverrides: Record<string, string> = {
  ...
  "kombuchas-dtox-et-sucres": "Kombuchas, DTÖX et sucres",
  "la-double-fermentation-du-dtox": "La double fermentation du DTÖX",
  "la-cure-dtox-comment-proceder": "La cure DTÖX, comment procÃ©der ?",
  ...
  "le-pouvoir-antioxydant-du-d-tox-kombucha": "Le pouvoir antioxydant du DTÖX Kombucha",
